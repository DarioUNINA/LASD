...
public:
  ...
  // Copy constructor
  // BST(argument) specifiers; // stub a BTLnk
  ...
  // Destructor
  // ~BST() specifiers; // dovrebbe essere default
  ...
  // type operator==(argument) specifiers; //usa gli iteratori in order (prima controlla la size)
  // type operator!=(argument) specifiers;
  ...
  // type Min(argument) specifiers; // (concrete function must throw std::length_error when empty) // torna il riferimento al nodo
...
protected:
  ...
  // type Detach(argument) specifiers; //stacca il nodo senza distrggerlo
  ...
  // type FindPointerToMin(argument) specifiers; // Both mutable & unmutable versions //ritorna un riferimento al puntatore a nodo
  // type FindPointerToMax(argument) specifiers; // Both mutable & unmutable versions

  // type FindPointerTo(argument) specifiers; // Both mutable & unmutable versions // da chiamare in insert e remove
