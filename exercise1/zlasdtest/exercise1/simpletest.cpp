...
void stestListInt(uint& testnum, uint& testerr) {
  ...
  try {
   lasd::List<int> lst;
    ...
    NonEqualList(loctestnum, loctesterr, lst, coplst, true); //PRIMO ERRORE
...
void stestListString(uint& testnum, uint& testerr) {
  ...
  try {
    ...
    FoldPostOrder(loctestnum, loctesterr, lst, true, &FoldStringConcatenate, string(""), string("X"), string("XB A ")); //PRIMO PROBLEMA
